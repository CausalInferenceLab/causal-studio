...
**Language:** Write all output documents (plan, comparison matrix) in Korean. Source titles and URLs stay in their original language; all narrative, headings, and analysis are in Korean.
